...
from src.apps.words.repositories.etymologies import EtymologiesRepository
...
class WordEtymologiesService(BaseService[WordEtymology]):
    def __init__(self) -> None:
        repository = EtymologiesRepository()
